...
renderElement(`.main`, createContentContainer(), `beforeend`);
...
renderElement(`.films`, createTopRatedContainer(), `beforeend`);
for (let i = 0; i < TOP_RATED_FILMS_NUMBER; i++) {
  renderElement(`.top-rated`, createFilmCardTemplate(), `beforeend`);
}
renderElement(`.films`, createMostCommentedContainer(), `beforeend`);
